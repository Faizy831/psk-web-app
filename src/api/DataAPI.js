...
const getPlayerTrainingSessionDataByExercise = async (
  playerID,
  trainingSessionID,
  exerciseID
) => {
 ...
 */
const getPlayerTrainingSessionAccuracyData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionTouchesData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionShootingData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionLongPassHandData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionShortPassData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionAccelerationData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionAgilityData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionGoalKeeperData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionDribbleData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionSidesData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionPowerData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionBiometricData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionVerticalJumpData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionStaminaData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 * Query database for data that corresponds to Touches exercise
 */
const getPlayerTrainingSessionLongPassData = async (
  playerID,
  trainingSessionID
) => {
  try {
 ...
 */
const getPlayerTrainingSessionSpeedData = async (
  playerID,
  trainingSessionID
) => {
  try {
...
const DataAPI = {
  ...
  getPlayerTrainingSessionDataByExercise:
    getPlayerTrainingSessionDataByExercise,
  ...
  getPlayerTrainingSessionVerticalJumpData:
    getPlayerTrainingSessionVerticalJumpData,
