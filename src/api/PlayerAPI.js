...
const getTrainingSessionPlayers = async (trainingSessionID) => {
    ...
    try {
        const playerTrainingSessions = (await PlayerTrainingSessionAPI.getPlayerTrainingSessionFromTS(trainingSessionID))
        ...
        for await (const playerTS of playerTrainingSessions) {
            ...
            if(player === null || !notIn(players, player) || player.Deleted == true){
                continue;
